...
--Q2. Which customer used a discount but still more than the average purchase amount?
...
--Q5. Do subscribed customer spend more? Compare average spend and total revenue between subscribe and non-subscribe?
select subscription_status,
count(customer_id) as total_customer,
round(avg(purchase_amount),2) as avg_spend,
round(sum(purchase_amount)) revenue
from customer
